 ...
 * This class is Queen Class. Used to create Queen objects. This class has methods to 
 * set image for object. And uses Convenience methods to register mouse event handlers.
 * The Queen logic works entirely on mouse release and switch turns.  
...
public class Queen extends Piece {
	...
	//Constructor
	public Queen(String pieceName, String pieceColor, int x, int y, Image img) {
		super(pieceName, pieceColor);
		this.image = img;
		
		move(x , y);
		
		Rectangle queen = new Rectangle(Board.TILE_SIZE * 0.80, Board.TILE_SIZE * 0.80);
	...
	private void mouseCommands() {
		...
		setOnMouseReleased(e -> {
			if(TakeTurns.turn.contentEquals("Player1") && this.getPiece_color().contentEquals("Color1") || TakeTurns.turn.contentEquals("Player2") && this.getPiece_color().contentEquals("Color2")) {
				...
				//This logic is a combination of Bishop class and Rook class logics.
				} else {
